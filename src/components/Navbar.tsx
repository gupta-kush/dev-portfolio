export function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full p-6 md:p-12 flex justify-between items-center z-50 mix-blend-difference pointer-events-none text-[var(--color-text)]">
      <a
        href="#top"
